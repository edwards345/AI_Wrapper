...
const THEMES: Record<ProviderName, ProviderTheme> = {
  ...
  grok: {
    ...
    prose: "[&_h1]:text-[#d0d0d0] [&_h1]:text-lg [&_h1]:font-semibold [&_h1]:mb-2 [&_h1]:mt-4 [&_h2]:text-[#d0d0d0] [&_h2]:text-base [&_h2]:font-semibold [&_h2]:mb-2 [&_h2]:mt-3 [&_h3]:text-[#d0d0d0] [&_h3]:text-sm [&_h3]:font-semibold [&_h3]:mb-1 [&_h3]:mt-2 [&_p]:text-[#b0b0b0] [&_p]:text-sm [&_p]:leading-relaxed [&_p]:mb-2 [&_ul]:text-[#b0b0b0] [&_ul]:text-sm [&_ul]:ml-4 [&_ul]:mb-2 [&_ul]:list-disc [&_ol]:text-[#b0b0b0] [&_ol]:text-sm [&_ol]:ml-4 [&_ol]:mb-2 [&_ol]:list-decimal [&_li]:mb-1 [&_strong]:text-[#d0d0d0] [&_a]:text-[#f97316] [&_a]:underline [&_blockquote]:border-l-2 [&_blockquote]:border-[#f97316] [&_blockquote]:pl-3 [&_blockquote]:italic [&_blockquote]:text-[#999] [&_hr]:border-[#27272a] [&_hr]:my-3 [&_table]:text-sm [&_table]:w-full [&_th]:text-left [&_th]:pb-1 [&_th]:border-b [&_th]:border-[#27272a] [&_th]:text-[#d0d0d0] [&_td]:py-1 [&_td]:border-b [&_td]:border-[#1c1c1f]",
